"""
В данном блоке кода содержится описание базз данных через подхож ORM
"""
...
#нужна для сохранения посылок с вердиктами по пользователям
...
#таблица с данным о пользователях
class UserRow(Base):
    __tablename__ = "users"
